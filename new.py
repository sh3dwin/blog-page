...
class BlogBlogpost(models.Model):
    ...
    edited_last = models.DateTimeField()
...
class BlogComment(models.Model):
    ...
    blog_post = models.ForeignKey(BlogBlogpost, models.DO_NOTHING)
    blog_user = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
